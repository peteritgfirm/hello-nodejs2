...
sam package --output-template package.yml --s3-bucket itg-bucket-one

sam deploy --template-file package.yml --capabilities CAPABILITY_IAM --region us-east-1 --stack-name aws-sam-hello-nodejs2
